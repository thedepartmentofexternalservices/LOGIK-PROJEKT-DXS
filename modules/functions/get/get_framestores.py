...
if __name__ == "__main__":
    ...
    if framestores is not None:
        print(f"  Framestore list:")
        for framestore in framestores:
            print(f"  {framestore}")
    else:
        print("Failed to retrieve framestore list.")
