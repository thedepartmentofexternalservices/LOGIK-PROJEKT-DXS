...
# ========================================================================== #
    ...
    src_nuke_envrc = "resources/cfg/direnv/envrc"

    # Set the tgt_nuke_envrc path
    tgt_nuke_envrc = f"{the_projekt_dir}/.envrc"

    # Copy archive prefs
    shutil.copy(src_nuke_envrc, tgt_nuke_envrc)

    # Print the copied file
    print("\n  Logik PROJEKT .envrc file created.")
