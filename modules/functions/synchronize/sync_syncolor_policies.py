...
# File Name:        sync_syncolor_policies.py
# Version:          2.0.0
# Created:          2024-01-19
# Modified:         2024-12-31
...
def sync_color_policies(
    ...
    # elif the_projekt_os == "macOS":
        ...
        print(f"  Unsupported operating system.")
        return 1
    ...
    print(f"  Debug: tgt_projekt_policies_dir:  {tgt_projekt_policies_dir}")
    print(f"  Debug: src_policies_dir:          {src_policies_dir}")
    print(f"  Debug: tgt_policies_dir:          {tgt_policies_dir}")

    print(f"  synchronizing Syncolor policies directories.\n")
    ...
    result = subprocess.run(
        ["rsync"] + sync_opts + [f"{src_policies_dir}/", f"{tgt_policies_dir}/"],
        text=True,
        capture_output=True
    )
    ...
    print(f"\n  Syncolor policies synchronized.")
    print(f"\n" + separator + "\n")

    # # Use rsync to copy the projekt policies
    # result = subprocess.run(
    #     ["rsync"] + sync_opts + [f"{src_policies_dir}/", f"{tgt_projekt_policies_dir}/"],
    #     text=True,
    #     capture_output=True
    # )
    ...
    # os.symlink(tgt_policies_dir, tgt_projekt_policies_dir)

    # print(f"\n  Syncolor policies linked.")
    # print(f"\n" + separator + "\n")
