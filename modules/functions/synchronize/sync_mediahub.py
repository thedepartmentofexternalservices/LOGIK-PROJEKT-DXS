...
# Function to create default mediahub rules for the MediaHub
def sync_mediahub_rules(
        the_hostname,
        the_projekt_os,
        the_projekts_dir,
        the_projekt_flame_dirs,
    ...
    result = subprocess.run(
        ["rsync"] + sync_opts + [f"{src_mediahub_dir}/", f"{tgt_mediahub_dir}/"],
        text=True,
        capture_output=True
    )
...
def main():
    ...
    # Call the function to create default mediahub rules
    sync_mediahub_rules(
        the_hostname,
        the_projekt_os,
        the_projekts_dir,
