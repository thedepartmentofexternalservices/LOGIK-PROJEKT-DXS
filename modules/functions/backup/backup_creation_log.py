...
# -------------------------------------------------------------------------- #
    ...
    src_projekt_creation_log = "resources/tmp/current_projekt_creation_log"
    tgt_projekt_creation_log = os.path.join(
        tgt_cfg_hostname_dir,
        f"projekt_creation_log"
    )

    # Archive the PROJEKT creation log
    print(f"\n  Archiving PROJEKT creation log.\n")
