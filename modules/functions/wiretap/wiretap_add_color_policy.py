...
the_projekt_color_science = "ARRI_LogC_v3"

separator = '# ' + '-' * 75 + ' #'

# ========================================================================== #
# This section adds a color management policy to the new logik project.
# ========================================================================== #
...
def add_syncolor_policy(
    ...
    # -s "/syncolor/policies/Autodesk/$the_projekt_color_science" \
    # -n "/projects/$the_projekt_flame_name/syncolor"

    # ---------------------------------------------------------------------- #

    # Add Autodesk colorsync policy to the project node using wiretap
    /opt/Autodesk/wiretap/tools/current/wiretap_duplicate_node \\
    -s "/syncolor/policies/Shared/{the_projekt_color_science}" \\
    -n "/projects/{the_projekt_flame_name}/syncolor"
