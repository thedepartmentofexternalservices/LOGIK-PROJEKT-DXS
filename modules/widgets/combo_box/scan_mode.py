...
from modules.widgets.combo_box.items_scan_mode import combo_box_items_scan_mode
...
class WidgetScanMode(QComboBox):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_scan_mode")

        # Load items from the imported list
        self.addItems(combo_box_items_scan_mode)

        # Set default properties
        self.setCurrentText(self.get_default_scan_mode())
        self.setEditable(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_scan_mode",
            "widget_type": "QComboBox",
            "widget_label_name": "Scan Mode: ",
            "widget_default_value": self.get_default_scan_mode(),
            "widget_placeholder_value": "",
            "widget_item_values": "items_scan_mode.py",
