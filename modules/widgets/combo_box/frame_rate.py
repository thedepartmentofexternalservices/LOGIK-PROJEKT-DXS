...
from modules.widgets.combo_box.items_frame_rate import combo_box_items_frame_rate
...
class WidgetFrameRate(QComboBox):
    def __init__(self, parent=None):
        ...
        self.addItems(combo_box_items_frame_rate)
    ...
    def get_widget_parameters(self):
        widget_parameters = {
            ...
            "widget_label_name": "Framerate: ",
            "widget_default_value": self.get_default_framerate(),
            "widget_placeholder_value": "",
            "widget_item_values": "items_framerate.py",
    ...
    def get_default_framerate(self):
        """
        Reads the JSON file and returns the default framerate.
        """
