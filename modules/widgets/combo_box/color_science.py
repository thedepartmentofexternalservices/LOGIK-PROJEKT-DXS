...
from modules.widgets.combo_box.items_color_science import combo_box_items_color_science
...
class WidgetColorScience(QComboBox):
    def __init__(self, parent=None):
        ...
        self.addItems(combo_box_items_color_science)

        # Set default properties
        self.setCurrentText(self.get_default_color_science())
        self.setEditable(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_color_science",
            "widget_type": "QComboBox",
            "widget_label_name": "Color Science: ",
            "widget_default_value": self.get_default_color_science(),
            "widget_placeholder_value": "",
            "widget_item_values": "items_color_science.py",
            "widget_read_only": False
        }
        return widget_parameters

    def get_default_color_science(self):
        """
        ...
        try:
            with open(json_file_path, 'r') as file:
                data = json.load(file)
            color_science = data.get("Color Science: ")
