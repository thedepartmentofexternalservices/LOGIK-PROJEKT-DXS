...
from modules.widgets.combo_box.items_bit_depth import combo_box_items_bit_depth
...
class WidgetBitDepth(QComboBox):
    def __init__(self, parent=None):
        super().__init__(parent)
        
        # Set object name if needed
        self.setObjectName("template_bit_depth")

        # Load items from the imported list
        self.addItems(combo_box_items_bit_depth)

        # Set default properties
        self.setCurrentText(self.get_default_bit_depth())
        self.setEditable(False)

    def get_widget_parameters(self):
        widget_parameters = {
            "widget_name": "template_bit_depth",
            "widget_type": "QComboBox",
            "widget_label_name": "Bit Depth: ",
            "widget_default_value": self.get_default_bit_depth(),
            "widget_placeholder_value": "",
            "widget_item_values": "combo_box_items_bit_depth",
